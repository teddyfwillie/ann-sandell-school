...
export const staff: StaffMember[] = [
  {
    id: '1',
    slug: 'james-kollie',
    name: 'Mr. Biomah Yoryor',
    title: 'Principal',
    department: 'Administration',
    imageSrc: '/images/staff/principal.jpg',
    email: 'b.yoryor@annsandell.edu',
    phone: '+231 XXX XXX XXX',
    bio: 'Mr. Biomah Yoryor has dedicated over 15 years to education in Liberia. As Principal of Ann Sandell High School, he leads with a vision of academic excellence and holistic student development. His commitment to creating an inclusive learning environment has transformed the school into one of the region\'s most respected institutions.',
    education: ['B.A. in Education', 'M.Ed. in Educational Leadership', 'Ph.D. in Educational Leadership'],
